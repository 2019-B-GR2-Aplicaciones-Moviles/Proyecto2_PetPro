...
class WalkActivity : AppCompatActivity() {
    ...
    private var servicio: String = "Paseo"
    ...
    private lateinit var radioButtonCuota4: RadioButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        radioButtonCuota4 = findViewById(R.id.radioButton2Horas)
    }
